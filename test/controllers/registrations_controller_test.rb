...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { c_id: @registration.c_id, grade: @registration.grade, s_id: @registration.s_id } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { c_id: @registration.c_id, grade: @registration.grade, s_id: @registration.s_id } }
